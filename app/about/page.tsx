  ...
  return (
    <main id="main-content">
      <section className="relative flex min-h-svh items-end overflow-hidden bg-black px-[var(--gutter)] pb-10 text-white md:pb-16">
        <Image src="/images/timeless/site/about-hero-group.jpg" alt="Three Timeless models assembled on the painted court" fill priority sizes="100vw" className="object-cover opacity-70" />
      ...
      <ImageReveal parallax className="mx-[var(--gutter)] aspect-[4/5] md:aspect-[16/9] md:min-h-[60svh]"><Image src="/images/timeless/site/about-story.jpg" alt="Three members of the Timeless community standing together on the court" fill sizes="100vw" className="object-cover" /></ImageReveal>
      ...
      <section className="relative flex min-h-svh items-center overflow-hidden bg-black px-[var(--gutter)] text-white">
        <Image src="/images/timeless/site/about-philosophy.jpg" alt="Timeless models crossing through the frame in motion" fill sizes="100vw" className="object-cover opacity-45" /><div className="absolute inset-0 bg-black/35" />
