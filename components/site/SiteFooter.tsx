  ...
  return (
    <footer className="bg-black px-[var(--gutter)] pb-8 pt-24 text-white md:pt-36">
      ...
      <div className="grid gap-14 py-16 text-[.72rem] uppercase tracking-[.12em] md:grid-cols-[1fr_auto_auto_auto]">
        ...
        <div className="grid content-start gap-3"><Link href="/shop">Shop</Link><Link href="/journal">Journal</Link><Link href="/about">About</Link></div>
        <div className="grid content-start gap-3"><a href="#">Instagram</a><a href="mailto:hello@timeless.ng">Contact</a></div>
